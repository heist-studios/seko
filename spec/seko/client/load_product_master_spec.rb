  ...
  RSpec.describe Client do
    describe '#load_product_master' do
      it 'makes request to SEKO API' do
        ...
        product_master_parameters_list = Lists::ProductMasterParametersListV4.new(
          image:                   [image],
        ...
        product_master_request = Requests::ProductMasterV4Request.new(
      ...
      it 'makes request to SEKO API and log errors if response returns an error' do
        ...
        client                 = Client.new(api_key: 'ABC', live: true)
        product_master         = Resources::ProductMasterV4.new(product_code: 'TestProductCode', currency: 'error')
        product_master_request = Requests::ProductMasterV4Request.new(product_master: product_master)
        ...
        expect(logger).to have_received(:error)
          .with("SEKO GEM: load_product_master ERROR for product_code: 'TestProductCode'. " \
                "Message: 'The field Currency must be a string with a maximum length of 3.'")
      end
    end
end
