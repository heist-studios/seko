...
module Seko
  module Resources
    RSpec.describe ProductMasterUpdateParametersListV4 do
      describe '#to_json_body' do
        it 'returns correct json' do
          ...
          product_master_update_parameters_list = ProductMasterUpdateParametersListV4.new(
            image:                   [image],
          ...
          expect(product_master_update_parameters_list.to_json_body).to eq(
            {
              'Image' => [{
